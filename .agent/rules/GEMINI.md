...
- **UI Interaction Mandate:** NEVER use native browser pop-ups (alert, confirm, prompt). All user feedback and interactions must be implemented via internal application components following the established design system.
